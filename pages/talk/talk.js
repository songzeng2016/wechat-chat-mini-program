...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.onSocketOpen(function (res) {
      ...
      wx.sendSocketMessage({
        data: '1|' + openId + '|' + id + '|1|name已进入聚点'
      })

      console.log('S:学生A已链接')

      // https://sp.yangchengtech.com/milian/Handler/Handler.ashx?Action=GetNewChatList&ID=174&OpenID=opBIQ0XFERiNnAvDAcAycU_k0hUU

      // let getData = {
      //   Action: 'GetNewChatList',
      //   ID: id,
      //   OpenID: openId
      // }
      // wc.get(getData, (json) => {
  ...
  setNotice: function () {
    ...
    let json = {
      chat_type: 9,
      message: '禁止发布不良信息，被举报超过三次将会被系统自动踢出该聚点'
    }
